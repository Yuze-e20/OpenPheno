...
torchrun --nproc_per_node=8 --master_port=2222 ./pretrain/train.py \
    --train_csv_path ./data/Broad-270/assay_splits/fewshot/100%/train_data.csv \
    --val_csv_path ./data/Broad-270/assay_splits/fewshot/100%/test_data.csv \
    ...
    --save_dir ./pretrain_ckpt/setting3 \
    --pretrained \
